...
describe 'callable', ->
	...
	describe 'is_subset', ->
		it 'accepts a callable with a subset of args', ->
			...
			assert.is_true Callable.is_subset func3, func2
			assert.is_false Callable.is_subset func2, func3
		...
		it 'accepts a callable with a superset of returns', ->
			...
			assert.is_true Callable.is_subset func2, func3
			assert.is_false Callable.is_subset func3, func2

		it 'accepts a callable with a subset of args and a superset of returns', ->
			func23 = Callable AB, ABC
			func32 = Callable ABC, AB

			assert.is_true Callable.is_subset func32, func23
			assert.is_false Callable.is_subset func23, func32
